//! Filler example regression: the two authored example-picker programs
//! that seed the "Data and memory" and "Stack and locals" stages assemble
//! and run to their fixtures.
//!
